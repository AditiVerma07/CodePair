  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <select
        ...
        className="px-3 py-1.5 bg-slate-900 border border-slate-800 rounded-lg text-sm text-slate-200 font-mono focus:outline-none focus:border-cyan-500 transition-colors duration-200 cursor-pointer"
      >
